...
{echo' 
You can send us your feedback through e-mail by filling the enteries below:</br>
<div class="row">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="#" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Gurshaan Singh Arora</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 9925240047</h4>
		<h4 style="font-family:'typo' ">gurshaanarora7@gmail.com</h4>
		<h4 style="font-family:'typo' ">L.D. College of Engineering, Ahmedabad</h4></div></div>
		</p>
      </div>
